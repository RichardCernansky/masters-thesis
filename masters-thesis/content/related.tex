...
Across these benchmarks, common metrics to evaluate trajectory prediction \cite{madjid2025survey,Ettinger2021WOMD} include:
...
\begin{itemize}
    ...
    \item \textbf{\acf{fde}:} the Euclidean distance between the predicted final position (at the prediction horizon, e.g., \(3\,\mathrm{s}\) or \(6\,\mathrm{s}\)) and the true final position. This emphasizes endpoint accuracy.
